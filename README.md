...
<br/>
Download the five traces [here](https://hpca23.cse.tamu.edu/champsim-traces/speccpu/index.html) into traces folder.<br/>
For observations, experiments and conclusions, refer to the [report](https://docs.google.com/presentation/d/1tYBewUXklJLwoML9h82btmcHxFeTekeJnfdKhcOe8AI/edit?usp=sharing) and [presentation](https://youtu.be/gP0OHL0VMok).
